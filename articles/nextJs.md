...
最近正在写博客，考虑到页面用什么框架，想了许久最后选择了 `next.js`，不为别的就为了 `seo` 虽然内容本身就放在 `Issue` 中可以被搜索引擎找到，但多学点总没错。
...
Next.js 用一个 `<App>` 组件去渲染每一个 page ,所以我可以自定义 App 组件来实现一个公共的 `<Layout>`。
创建 `/pages/_app.tsx`:
...
[first_optimize_done]:https://raw.githubusercontent.com/jwdzzhz777/blog/master/assets/nextJs/1577688603309.jpg
[second_optimize]:https://raw.githubusercontent.com/jwdzzhz777/blog/master/assets/nextJs/1577689958466.jpg
